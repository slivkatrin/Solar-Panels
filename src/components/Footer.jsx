...
<footer class="bg-zinc-700">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-300 font-medium">
                      <li class="mb-4">
                          <a href="https://flowbite.com/" class="hover:underline">Careers</a>
                      </li>
                      <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-400 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Designed by slivkatrin</a>. All Rights Reserved.
          </span>
