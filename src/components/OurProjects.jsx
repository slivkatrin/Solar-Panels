...
<h1 className='text-[#555555] md:text-5xl sm:text-3xl text-2xl font-bold py-2 mx-auto text-center'>OUR PROJECTS</h1>
    ...
    <div className='flex flex-col justify-center md:ml-8'>
        <p className='text-[#a1d322] font-normal md:text-1xl sm:text-1xl text-1xl'>KNOW US BETTER</p>

        <h1 className='text-[#555555] md:text-5xl sm:text-3xl text-2xl font-bold py-2 text-left '>Our assembly</h1>
...
<button className='bg-[#a1d322] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3 text-white'>Learn more</button>
</div>
