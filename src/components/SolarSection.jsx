...
const SolarSection = () => {
    return (
        <div className="flex flex-col justify-center relative h-screen">
            <div style={{ height: '100%' }} className="w-full bg-gradient-to-r from-fadedLeft to-fadedRight absolute middle" />
            <div className="py-20 relative z-10">
                <p className="text-[#f5f8f5] font-normal md:text-1xl sm:text-1xl text-center text-1xl">
                    LET'S CALCULATE
                </p>
            ...
            <div className="flex flex-wrap justify-center items-center px-4 md:px-8 lg:px-16 relative z-10" style={{ marginBottom: '5%' }}>
