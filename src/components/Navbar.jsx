    ...
    return(
        ...
        <div className='w-full flex justify-between fixed top-0 left-0 bg-white shadow-xl items-center h-20  z-10 mx-auto px-4 text-grey'>
           ...
           <img className='h-12 m-1 ' src={logo} alt='' />
            ...
            <div className={!nav ? 'fixed left-0 top-0 w-[80%] h-full border-r border-r-gray-100 bg-white ease-in-out duration-500' : 'fixed left-[-100%]'}>
                <h1 className='w-full text-3xl font-bold text-accentColorGreen m-4'>Menu</h1>
